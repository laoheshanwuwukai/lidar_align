...
int main(int argc, char *argv[]) {
  ...
  // For test
  fs::path out = lidar_folder.parent_path() / "total.pcd";
  Eigen::Matrix4d T_ins_lidar;
  // clang-format off
  T_ins_lidar <<
  0.00171268 , -0.999997   ,-0.00180235 , -0.200659,
  0.999971   ,  0.00169915 , 0.00748545 , 0.74,
  -0.00748237, -0.00181512 , 0.99997    , -0.774098,
          0  ,        0    ,      0     ,     1;
  // clang-format on
  CombainClouds(T_ins_lidar, lidar_folder, ins_file, out);
