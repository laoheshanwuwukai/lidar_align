...
int main(int argc, char *argv[]) {
  ...
  lidar_align::Transform T_o_l(debug_config.t, debug_config.q);
  lidar.setOdomLidarTransform(T_o_l);
  std::string name = "cloud_" + std::to_string(debug_config.x) + "_" +
                     std::to_string(debug_config.y) + "_" +
                     std::to_string(debug_config.z) + "_" +
                     std::to_string(debug_config.roll) + "_" +
                     std::to_string(debug_config.pitch) + "_" +
                     std::to_string(debug_config.yaw) + ".ply";
